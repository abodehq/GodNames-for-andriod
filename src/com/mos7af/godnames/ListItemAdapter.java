...
public class ListItemAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView gNum = (TextView)vi.findViewById(R.id.gNum);
        ...
        gNum.setTypeface(tf);
        gNum.setText(sura.get("thumb") + "- ");
        thumb_image.setImageDrawable(activity.getResources().getDrawable(activity.getResources().getIdentifier("g"+sura.get("thumb"),"drawable",activity.getPackageName())));
